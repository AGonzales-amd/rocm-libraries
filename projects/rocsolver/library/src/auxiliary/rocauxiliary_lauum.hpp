                                        ...
                                        T* work)
{
    ...
    THROW_IF_ROCBLAS_ERROR(rocblasCall_trmm(handle, side, uplo, rocblas_operation_conjugate_transpose,
                                            rocblas_diagonal_non_unit, n, n, &one, 0, A, shiftA,
                                            lda, strideA, work, 0, n, strideW, batch_count));
